...
namespace aki\screenshot;


use aki\screenshot\Exceptions\InvalidArgumentException;
use aki\screenshot\Exceptions\PhantomJsException;
use aki\screenshot\Exceptions\TemplateNotFoundException;
use aki\screenshot\Image\Types;
use aki\screenshot\Image\Types\Type;
use aki\screenshot\Injection\LocalPath;
use aki\screenshot\Injection\Url;
use aki\screenshot\Location\Jobs;
use aki\screenshot\Location\Output;

/**
 * @author Akbar Joudi <akbar.joody@gmail.com>
 * 
 */
class ScreenShot extends \yii\base\Component
{
    ...
    public function save($imageLocation, $deleteFileIfExists = true)
    {
        ...
        $binPath = __DIR__.'/bin'.DIRECTORY_SEPARATOR;
        if(!file_exists($this->binPath.DIRECTORY_SEPARATOR.'phantomjs.exe')){
    ...
    private function getTemplateResult($templateName, array $args)
    {
        ...
        if(!file_exists($templatePath)){
            $templatePath = __DIR__.'/templates' . DIRECTORY_SEPARATOR . $templateName . '.php';
        }
